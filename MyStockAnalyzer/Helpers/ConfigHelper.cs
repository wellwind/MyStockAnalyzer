...
namespace MyStockAnalyzer.Helpers
{
    public class ConfigHelper
    {
        ...
        // 股價資訊
        public static string StockPriceUrl1 = "http://www.twse.com.tw/ch/trading/exchange/STOCK_DAY/STOCK_DAY_print.php?genpage=genpage/Report{0}{1}/{0}{1}_F3_1_8_{2}.php&type=csv";
        public static string StockPriceUrl2 = "http://www.gretai.org.tw/web/stock/aftertrading/daily_trading_info/st43_download.php?l=zh-tw&d={0}/{1}&stkno={2}&s=0,asc,0";
        ...
        // 大盤資訊
        public static string StockMapUrl1 = "http://www.twse.com.tw/ch/trading/indices/MI_5MINS_HIST/MI_5MINS_HIST.php?myear={0}&mmon={1}";
        public static string StockMapVolumeUrl1 = "http://www.twse.com.tw/ch/trading/exchange/FMTQIK/FMTQIK2.php?STK_NO=&myear={0}&mmon={1}&type=csv";

        // 即時股價資訊
        public static string StockRealDataUrl = "http://mis.twse.com.tw/stock/api/getStockInfo.jsp?ex_ch={0}&json=1&delay=0";
